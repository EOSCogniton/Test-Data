...
T_2 = readtable('SE-20-002-E02_2_carto_modif_session_1.txt');
...
figure(1)
%  T_1
plot(rpm_1,ch_roue_corrige_1,'b')
hold on
grid on
plot(rpm_1,couple_roue_corrige_1,'r')
% T_2
plot(rpm_2,ch_roue_corrige_2,'--b')
plot(rpm_2,couple_roue_corrige_2,'--r')
title('Puissance et Couple corrigé au roue')
